...
$(document).on('click', '#FAKULTET li a',function(){
    ...
    $("html, body").animate({ scrollTop: $('#department').offset().top }, 1000);
...
$(document).on('click', '#SMER li a', function(){
	...
	$("html, body").animate({ scrollTop: $('#year').offset().top }, 1000);
});
...
$(document).on('click', '#PREDMET li a', function(){
    ...
    $("html, body").animate({ scrollTop: $('#pretrazi').offset().top }, 1000);
});
