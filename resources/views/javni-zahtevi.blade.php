        ...
        <div class="row">
            <div class="col-xs-12 col-xs-offset-0 col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading"><strong>JAVNI ZAHTEVI</strong></div>
                    <div class="panel-body">
                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-3">
                                                                    {{csrf_field()}}
                                                                    <button href='#' type="button" id="prihvati" class="btn btn-sm btn3d btn-success col-xs-12" onclick="prihvatiJavniZahtev('{{$zahtev->sifZahteva}}')"><b align="center">Prihvati</b></button>
                                                                </div>
                        ...
                        @endforeach
			@if($i==0) <strong>Nema javnih zahteva</strong> @endif
