                ...
                <div class="row">
                    ...
                    <div class="col-md-9 personal-info">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            Ovde cemo da stavljamo <strong>.alert</strong>. Dodavacemo neka vazna obavestenja. <br>
                        </div>
                        <div class="alert alert-info alert-dismissable">
                            <a class="panel-close close" data-dismiss="alert">×</a>
                            <i class="fa fa-coffee"></i>
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input class="form-control" id="ime" type="text" value="{{ Auth::user()->firstname }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Prezime:</label>
                                <div class="col-lg-8">
                                    <input class="form-control" id="prezime" type="text" value="{{ Auth::user()->lastname }}" readonly>
                                </div>
                            </div>
