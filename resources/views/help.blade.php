        ...
        <div class="container">
				...
				<div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako da izaberem predmet?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Na početnoj stranici imate opciju da izaberete fakultet, nakon toga birate smer, pa godinu na fakultetu. Kada budete izabrali godinu otvoriće Vam se kartica sa predmetima koje možete da birate.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako da kontaktiram predavača?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Kada izaberete predmet prikazaće Vam se oglasi od predavača. Klikom na &ldquo;Kontaktiraj&rdquo; otvara se formular u kome morate ostaviti svoj e-mail i telefon.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako ću znati da je predavač video moj zahtev?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Kada kontaktirate predavača, on će moći da prihvati ili odbije Vaš zahtev o čemu ćete biti obavešteni preko e-maila.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Šta ako je predavač prihvatio moj zahtev?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Dobićete e-mail u kome će biti verifikacioni link i otvaranjem njega prikazuju Vam se podaci o predavaču.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Šta ako je predavač odbio moj zahtev?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Dobićete e-mail sa porukom o odbijenom zahtevu.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Da li mogu da vidim koje predmete drži predavač?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Kada izaberete predmet prikazaće Vam se oglasi od predavača. Klikom na profilnu sliku ili na ime otvara Vam se profil predavača gde možete videti sve predmete koje on drži.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako da ocenim predavača?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Dobićete e-mail u kome će biti link i otvaranjem njega moći ćete da ocenite i/ili preporučite predavača.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
				...
				<div class="article ">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako da vidim podatke o korisniku čiji sam zahtev prihvatio?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>Podaci o svakom korisniku ce biti dosupni u sekciji prihvaćeni zahtevi.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
                            ...
                            <div class="article ">
                                <div class="item row">
                                    ...
                                    <div class="col-xs-6">
                                        <p class="title">Kako da pošaljem korisniku anketu za ocenjivanje?</p>
                                    </div>
                                    <div class="col-xs-3">
                                        <p class="pubdate"></p>
                                    </div>
                                ...
                                <div class="description row">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="description-text">
                                            <p>U sekciji prihvaćeni zahtevi moći ćete da pošaljete link sa anketom na korisnikov e-mail ukoliko je on verifikovao zahtev.</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-3">&nbsp;</div>
                                </div>
