                    ...
                    <div href = "#" class = "thumbnail" style="background-color: rgba(254, 254, 254, 0.8); ">
                        ...
                        <form action="/predaja-oglasa" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-xs-2 col-form-label"><b>NAZIV PROFESORA: </b></label>
                                <div class="col-xs-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="list-group-item col-xs-3 col-xs-offset-2">
                                    <div id="recaptcha" class="g-recaptcha" data-sitekey="6Le5GwgUAAAAALb8JRwwctlhV3Yn23UTbOEEc6GR"></div>
                                </div>
                            </div>
                        </form>
                    </div>
