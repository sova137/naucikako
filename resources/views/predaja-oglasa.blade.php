                ...
                <div href = "#" class = "thumbnail" style="border-radius: 10px;">
                    ...
                    <form action="/predaja-oglasa" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-7 col-xs-12" ><b style="color: #2d4373">Obaveštenja o pristiglim zahtevima za čas se podrazumevano šalju na Vaš email!
                        ...
                        <div class="form-group row">
                            ...
                            <label class="checkbox-inline col-md-2 col-md-offset-1 col-xs-11 col-xs-offset-1"><input type="checkbox" name="SMScheck" id="SMS-obavestenje" value="0"><b>Obavesti me SMS porukom o pristiglim zahtevima</b></label>
                            @if( (\App\Profesor::odUsera(Auth::user()))->telefon == null)
                            <label id="predaja-oglasa-br-telefona" class="col-xs-12 col-md-3 phone-number"  ><b>Broj telefona*</b>
                        ...
                        <div class="form-group row">
                            <div class="list-group-item col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-2">
