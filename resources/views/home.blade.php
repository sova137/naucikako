...
@section('content')
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-12 col-xs-offset-0 col-md-3 col-md-offset-3">
                                                                {{csrf_field()}}
                                                                <button href='#' type="button" id="prihvati" class="btn btn3d btn-sm btn-success col-xs-12" onclick="prihvatiOnClick('{{$zahtev->sifZahteva}}')" ><b align="center">Prihvati</b></button>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-12 col-xs-offset-0 col-md-3 col-md-offset-3">
                                                                {{csrf_field()}}
                                                                <button href='#'  type="button" id="odbaci" onclick="odbaciOnClick('{{$zahtev->sifZahteva}}')" class="btn btn3d btn-sm btn-danger col-xs-12" ><b align="center">Odbaci</b></button>
                                                            </div>
 ...
 <?php include('../resources/views/dialog-box-podaci-ucenika.blade.php');?>                                                            
                        ...
                        @endforeach
			@if($i==0) <strong>Nema pristiglih zahteva</strong> @endif
                    </div>
                </div>
            </div>
