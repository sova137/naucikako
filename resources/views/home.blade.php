                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="list-group-item col-xs-3 col-xs-offset-3">
                                                                {{csrf_field()}}
                                                                <button href='#' type="button" id="prihvati" class="btn btn-sm btn-primary col-xs-12" onclick="prihvatiOnClick('{{$zahtev->sifZahteva}}')" style="background-color:green"><b align="center">Prihvati</b></button>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="list-group-item col-xs-3 col-xs-offset-3">
                                                                {{csrf_field()}}
                                                                <button href='#'  type="button" id="odbaci" onclick="odbaciOnClick('{{$zahtev->sifZahteva}}')" class="btn btn-sm btn-primary col-xs-12" style="background-color:red"><b align="center">Odbaci</b></button>
                                                            </div>
