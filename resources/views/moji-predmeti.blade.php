                                                                 ...
                                                                 <div href = "#" class = "thumbnail">
                                                                    ...
                                                                    <!-- <form action="/moji-predmeti" method="POST">-->
                                                                         ...
                                                                         <div class="form-group row">
                                                                             ...
                                                                             <label class="col-xs-12 col-md-5 "><b style="color: mediumvioletred">Obaveštenja o pristiglim zahtevima za čas se podrazumevano šalju na Vaš email!</b></label>
                                                                         ...
                                                                         <div class="form-group row">
                                                                             ...
                                                                             <label class="checkbox-inline col-xs-12 col-md-2 col-md-offset-1"><input type="checkbox" name="SMScheck" id="SMScheck-{{$predmeti[$j]->sifPredaje}}" checked><b>Obavesti me SMS porukom o pristiglim zahtevima</b></label>
                                                                             @else
                                                                         ...
                                                                         <div class="form-group">
                                                                             ...
                                                                             <textarea rows="5" name="opis-text-input" class="form-control" id="predaja-opis-oglasa-{{$predmeti[$j]->sifPredaje}}" placeholder="Opišite svoje iskustvo u vezi izabranog predmeta...">{{$predmeti[$j]->o}}</textarea>
                                                                         </div>

                                                                         <div class="form-group row">

                                                                             <div class="list-group-item col-xs-12 col-xs-offset-0 col-md-3 col-md-offset-2">
                                                                                 <button href='#' id="sacuvaj-izmene-oglasa-btn" class="btn btn-sm btn-primary col-xs-12" onclick="updateSubjectOffer('{{$predmeti[$j]->sifPredm}}',$('#predaja-opis-oglasa-{{$predmeti[$j]->sifPredaje}}').val(),'{{$predmeti[$j]->sifPredaje}}')"><b align="center">Sačuvaj izmene</b></button>
                                                                             </div>
